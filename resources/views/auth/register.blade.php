    ...
    <div class="flex w-screen text-slate-800">
        <div
            ...
            <div class="mx-auto py-16 px-8 text-white xl:w-[40rem]">
                ...
                <p class="my-6 text-3xl font-semibold leading-10">Temukan cara baru belajar <span
                        class="whitespace-nowrap rounded-lg bg-orange-400 px-1 text-white">budaya</span> dengan <span
                        class="whitespace-nowrap rounded-lg bg-orange-400 px-1 text-white">teknologi</span> terbaru</p>
                <p class="mb-4">Gabungkan budaya dan teknologi dalam pengalaman belajar yang interaktif dan
                    menyenangkan. Jelajahi materi budaya yang kaya dengan metode pembelajaran terkini.</p>
            </div>
        </div>
                ...
                <form method="post" action="{{ route('register') }}" class="flex flex-col items-stretch">
                    ...
                    <div class="flex flex-col pt-4">
                        <div class="relative flex overflow-hidden">
                            <input type="text" name="name" placeholder="name" value="{{ old('name') }}"
                                class="w-full flex-shrink appearance-none rounded-md border-slate-300 bg-white py-2 px-4 text-base text-slate-700 placeholder-slate-400 focus:outline-none @error('name') border-red-500 bg-red-50 text-red-900 placeholder-red-700 @enderror" />
                        </div>
                        @error('name')
                    ...
                    <div class="flex flex-col pt-4">
                        <div class="relative flex overflow-hidden">
                            <input type="password" name="password_confirmation" placeholder="Confirm Password"
                                class="w-full flex-shrink appearance-none rounded-md border-slate-300 bg-white py-2 px-4 text-base text-slate-700 placeholder-slate-400 focus:outline-none @error('password_confirmation') border-red-500 bg-red-50 text-red-900 placeholder-red-700 @enderror" />
                        </div>
                    ...
                    <div class="block mt-4">
                        <input
                            ...
                            type="checkbox" id="remember-me" checked />
                        <label class="inline-block" for="remember-me"> I agree to the <a class="underline"
                                href="#">Terms and Conditions</a></label>
                    </div>
                    <button type="submit"
                        class="mt-2 rounded-lg bg-blue-600 px-4 py-2 text-center text-base font-semibold text-white shadow-md outline-none ring-blue-500 ring-offset-0 transition hover:bg-blue-700 focus:ring-0 md:w-32">Register</button>
                </form>
            </div>
        </div>
    </div>
