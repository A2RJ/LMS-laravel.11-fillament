    ...
    <div class="flex w-screen text-slate-800">
            ...
            <div class="my-auto mx-auto flex flex-col justify-center px-6 pt-8 md:justify-start lg:w-[28rem]">
                ...
                <div class="py-12 text-center">
                    <p class="text-slate-600">
                        ...
                        <a href="{{ route('register') }}" class="whitespace-nowrap font-semibold text-blue-500 underline underline-offset-4">Sign up for free.</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="relative hidden h-screen select-none bg-blue-600 bg-gradient-to-br md:block md:w-1/2">
            <div class="py-16 px-8 text-white xl:w-[40rem]">
                ...
                <p class="my-6 text-3xl font-semibold leading-10">Cara baru belajar budaya Samawa dengan <span class="abg-white whitespace-nowrap py-2 text-cyan-300">SAMADA (Samawa Daring)</span>.</p>
                <p class="mb-4">Kini, belajar budaya Samawa lebih mudah dan menyenangkan. Jelajahi materi pembelajaran daring yang interaktif dan menarik.</p>
            </div>
