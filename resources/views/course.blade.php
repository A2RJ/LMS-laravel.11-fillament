...
<div class="max-w-screen-lg mx-auto pt-4">
    <nav aria-label="Breadcrumb" class="p-4">
        <ol class="flex items-center gap-1 text-sm text-slate-600">
            ...
            <li>
                <a href="{{ route('category.id', $course->category->id) }}"
    ...
    <div
        class="max-w-screen-md lg:max-w-screen-lg mx-auto bg-white border border-slate-300 rounded-lg grid grid-cols-12">
                    ...
                    <div role="alert" class="mb-4 rounded border-s-4 border-blue-500 bg-blue-50 p-4">
                        ...
                        <div class="bg-blue-300 rounded-full mt-4 transition duration-300">
                            ...
                            <span role="progressbar" aria-labelledby="ProgressLabel"
                                aria-valuenow="{{ $progressPercentage }}" class="block rounded-full bg-gray-200">
                        ...
                        @if ($progressPercentage == 100)
                            <a href="#"
                                class="flex justify-center items-center gap-2 bg-blue-700 rounded-lg mt-2 shadow-sm text-sm text-white font-semibold py-2 px-4 transition-all duration-500 hover:bg-blue-500">
                                Download Certificate
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" width="32" height="32"
                                    viewBox="0 0 24 24">
                ...
                <ol class="space-y-2 list-none -ml-5">
                    <li class="">
                        <a href="{{ route('course.id', ['course' => $course->id]) }}">
                            <div
                                class="w-full p-3 text-blue-700 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:border-blue-800 dark:text-blue-400">
