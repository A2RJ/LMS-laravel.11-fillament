                ...
                <div class="py-1">
                    ...
                    <div class="flex flex-col space-y-1">
                        <p class="inline-flex items-center gap-1 text-sm leading-none text-gray-400">
                            ...
                            <span>{{ count($category->classes) }} Courses</span>
                        </p>
                        <p class="inline-flex items-center gap-1 text-sm leading-none text-gray-400">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-500" width="32" height="32"
                                viewBox="0 0 24 24">
                    ...
                    <div class="text-right mt-3">
                        <a href="{{ route('category.id', $category->id) }}">
                            <button
                                class="px-3 py-1 border-2 border-blue-500 rounded-lg text-blue-500 hover:text-white hover:bg-blue-500 transition duration-150">
                                Detail
                            </button>
                        </a>
                    </div>
