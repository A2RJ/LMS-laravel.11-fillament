...
@section('content')
    ...
    <section class="pt-8 lg:pt-32 bg-gradient-to-br from-white via-sky-200 to-white">
        <div class="max-w-screen-xl mx-auto">
            <div class="grid grid-cols-2">
                ...
                <div class=" flex justify-end items-end">
                    <img class="h-80" src="/hero-2.png" alt="" srcset="/hero-2.png">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="flex justify-end gap-2 mt-3">
                ...
                @else
                    <a href="{{ $categories->previousPageUrl() }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white group-hover:text-blue-500"
                            width="32" height="32" viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="m7.85 13l2.85 2.85q.3.3.288.7t-.288.7q-.3.3-.712.313t-.713-.288L4.7 12.7q-.3-.3-.3-.7t.3-.7l4.575-4.575q.3-.3.713-.287t.712.312q.275.3.288.7t-.288.7L7.85 11H19q.425 0 .713.288T20 12t-.288.713T19 13z" />
                        </svg>
        ...
        <div class="mb-4">
            ...
            <div class="mt-10 flex justify-center">
                <a href="{{ route('course') }}"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="group-hover:text-blue-500" width="32"
                        height="32" viewBox="0 0 24 24">
