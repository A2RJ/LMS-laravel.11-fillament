...
<div class="max-w-screen-lg mx-auto">
    ...
    <div class="mb-10">
        <div class="grid grid-cols-12 gap-4 mx-auto">
            <div
                class="col-span-9 relative isolate overflow-hidden bg-white px-6 pt-2 pb-6 text-center sm:rounded-3xl sm:border sm:border-slate-100 sm:px-16 sm:shadow-sm">
                ...
                <h3 class="mx-auto mt-6 max-w-xl text-lg sm:text-sm leading-8 text-gray-500">
                    E-learning about culture offers an interactive and engaging approach to learning the traditions,
                    language, and history of Sumbawa, through videos, quizzes, and immersive simulations.
                </h3>
                <div class="mt-8 flex items-center justify-center gap-x-6">
                    <a class="inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-3 text-sm font-semibold text-white shadow-sm transition-all duration-150 hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
                        href="#">
                        Explore the course
                ...
                <div class="flex h-full flex-col rounded-2xl rounded-br-2xl bg-slate-200">
                    <ul class="flex flex-col">
                        <li class="relative transition">
                            <div
                                class="relative m-2 bg-blue-500 text-white flex cursor-pointer items-center rounded-xl py-3 pl-5 text-sm hover:bg-slate-50">
                        ...
                        <li class="relative transition">
                            ...
                            <div
                                class="relative m-2 flex items-center rounded-xl border-b-4 border-slate-300 bg-slate-50 py-3 pl-5 text-sm text-slate-500">
                                <span class="mr-5 flex w-5 text-slate-500">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="peer-checked:rotate-180 absolute right-0 top-6 mr-5 ml-auto h-4 text-slate-500 transition"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                            </svg>
                            <ul
                                class="duration-400 peer-checked:max-h-96 m-2 flex max-h-0 flex-col overflow-hidden rounded-2xl bg-slate-100 transition-all duration-300">
                                @forelse ($classes->take(5) as $class)
                                    <li
                                        class="m-2 flex cursor-pointer rounded-xl py-3 pl-5 text-sm text-slate-500 hover:bg-white">
                                        <span class="mr-5">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" width="32" height="32"
                                                viewBox="0 0 24 24">
                                                <path fill="currentColor"
                                                    d="M4 15.77v-1h7.02v1zm0-4v-1h10.962v1zm0-4v-1h10.962v1zM16.442 20v-5.942l4.577 2.98z" />
                                            </svg>
                                        </span>
                                        {{ $class->title }}
                                    </li>
                ...
                <div
                    ...
                    <div class="py-1 px-6 pb-6">
                        ...
                        <div class="flex flex-col space-y-1">
                            ...
                            <p class="inline-flex items-center gap-1 text-sm leading-none text-gray-400">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-blue-500" width="32" height="32"
                                    viewBox="0 0 24 24">
                                    <path fill="currentColor"
                        ...
                        <div class="text-right mt-3">
                            <a href="{{ route('course.id', $class->id) }}">
                                <button
