...
<div class="max-w-screen-lg min-h-[60vh] mx-auto mb-10 ">
    ...
    <div class="grid grid-cols-12 gap-4">
        ...
        <div class="col-span-8 bg-white p-4 rounded-lg">
            <form id="form"
                action="{{ route('post.test.id', ['class' => $class->id, 'session' => $session->id, 'test_type_id' => $session->test->id, 'test_type' => request('test')]) }}"
                method="post">
                @csrf
                    ...
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Perhatian:
                                    Jawaban Belum Lengkap</h3>
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">Harap periksa kembali, belum semua pertanyaan telah
                                        dijawab.</p>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('next-btn').addEventListener('click', () => {
                ...
                const totalQuestions = Array.from(questions).filter(question => question.querySelector('input[type="radio"]') || question.querySelector('textarea')).length;
