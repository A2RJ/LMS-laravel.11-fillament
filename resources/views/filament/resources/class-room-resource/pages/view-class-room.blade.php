            ...
            <div class="col-span-12 lg:col-span-8">
                ...
                <div
                    ...
                    <div class="flex items-center gap-1">
                        <svg class="text-blue-500 w-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M6 6.878V6a2.25 2.25 0 0 1 2.25-2.25h7.5A2.25 2.25 0 0 1 18 6v.878m-12 0c.235-.083.487-.128.75-.128h10.5c.263 0 .515.045.75.128m-12 0A2.25 2.25 0 0 0 4.5 9v.878m13.5-3A2.25 2.25 0 0 1 19.5 9v.878m0 0a2.246 2.246 0 0 0-.75-.128H5.25c-.263 0-.515.045-.75.128m15 0A2.25 2.25 0 0 1 21 12v6a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18v-6c0-.98.626-1.813 1.5-2.122" />
                        </svg>
                        <b>{{ $this->getRecord()->category?->category }}</b>
                    </div>
                    <div class="flex items-center gap-1">
            ...
            <div
                ...
                <div class="flex flex-col gap-2">
                    <a
                        ...
                        <div class="group">
                            <div
                                class="flex items-center justify-between gap-1 rounded-md border border-slate-500 p-2 cursor-pointer hover:border-blue-500 group-hover:bg-blue-500 {{ !request('lesson') ? 'bg-blue-500 text-white' : '' }}">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    class="w-4 h-4 {{ !request('lesson') ? 'text-white' : 'text-orange-500' }}">
                                    <path stroke-linecap="round" stroke-linejoin="round"
