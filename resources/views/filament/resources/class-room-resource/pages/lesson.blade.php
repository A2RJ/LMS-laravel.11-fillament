        ...
        <div class="grid grid-cols-12 gap-4">
            <div class="col-span-12 lg:col-span-8">
                ...
                <div class="flex justify-between flex-col mt-2 lg:flex-row font-normal text-slate-600 text-xs lg:text-sm">
                    ...
                    <div class="flex items-center gap-1">
                        <svg class="text-slate-500 w-4 h-4 p-[2px] border border-slate-500 rounded-full" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <p class="">
                    <x-tinyview :view="$this->lesson->content"></x-tinyview>
                </p>
            </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <a href="{{ route('filament.admin.resources.class-rooms.lesson', ['record' => $this->getRecord()->id, 'lesson' => $session->id]) }}">
                        <div class="group">
                            ...
                            @else
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 group-hover:text-white text-blue-500">
